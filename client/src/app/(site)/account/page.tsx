...
import EditImageProfileForm from '@/features/user/components/EditImageProfileForm';
...
const AccountPage = () => {
	...
	return (
		<div className="mx-auto max-w-[67.5rem]">
			<Breadcrumb pageName="הפרופיל שלי" />
			...
			<div className="grid grid-cols-5 gap-8">
				<div className="col-span-5 xl:col-span-3">
					<div className="rounded-sm border border-[#E2E8F0] bg-white shadow-default">
						<div className="border-b border-[#E2E8F0] py-4 px-7">
							<h3 className="font-medium text-black">הגדרות משתמש</h3>
						</div>
						<div className="p-7">
							<EditProfileForm />
						</div>
				...
				<div className="col-span-5 xl:col-span-2">
					<div className="rounded-sm border border-[#E2E8F0] bg-white shadow-default">
						<div className="border-b border-[#E2E8F0] py-4 px-7">
							<h3 className="font-medium text-black">תמונת פרופיל</h3>
						</div>
